...
public class Controller {
	...
	/**
	 * Recebe a matriz, posição inicial e final da matriz para efetuar a
	 * ordenação. Define o "meio" da lista e separa em duas outras listas até
	...
	/**
	 * Percorre a matriz comparando todas as suas posições até ordenar todas
	 * a matriz.
	 * 
	 * @param insertionSort
